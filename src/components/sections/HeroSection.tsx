...
export function HeroSection() {
  ...
  return (
    ...
    >
      {/* Background image */}
      <div ref={imageRef} className="absolute inset-0 opacity-0" style={{ scale: 0.92 }}>
        <img
      ...
      >
        <span className="font-mono text-[9px] tracking-[0.2em] uppercase text-[var(--color-muted)]">Scroll</span>
